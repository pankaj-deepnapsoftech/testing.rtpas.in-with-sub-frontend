      ...
      >
        <div className="flex gap-6">
          <motion.a
            ...
            className="flex items-center justify-center w-16 h-16 bg-gradient-to-r from-blue-500 to-sky-500 rounded-full text-white shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110"
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-6 reveal">
              {cardsContent.map((card, index) => (
                <motion.div
                  key={index}
                  viewport={{ once: true }}
                  className="group bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl flex flex-col items-center text-center transform transition-all duration-500 hover:scale-105 hover:-translate-y-2 border border-gray-100 hover:border-green-200 relative overflow-hidden h-full justify-between"
                ...
                >
                  ...
                  <div className="relative z-10 flex flex-col items-center w-full h-full">
                    ...
                    <p className="text-gray-600 text-sm leading-relaxed mb-4 min-h-[48px] flex items-center text-center">
                      {card.description}
                    </p>
                    ...
                    <div className="mt-auto">
                      <motion.a
                        ...
                        viewport={{ once: true }}
                        target={
                          card.link.includes("maps.google.com")
                            ? "_blank"
                            : "_self"
                        }
                        rel={
                        ...
                        className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-500 to-sky-500 text-white rounded-lg text-sm font-medium hover:from-blue-600 hover:to-sky-600 transition-all duration-300 transform hover:scale-105"
            ...
            >
              ...
              <div className="relative z-10">
                <h2 className="text-3xl font-bold mb-6 bg-gradient-to-r from-blue-500 to-sky-600 bg-clip-text text-transparent">
                  Get In Touch
                </h2>
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="w-full bg-gradient-to-r from-blue-600 to-sky-600 hover:from-blue-700 hover:to-sky-700 text-white py-4 rounded-xl font-bold text-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {loading ? (
